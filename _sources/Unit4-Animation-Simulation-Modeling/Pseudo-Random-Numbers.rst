...
.. fillintheblank:: mcsp-4-7-1
    ...
    Suppose our PRNG generates the following sequence of numbers and suppose you seeded it with the value 11:... 14 11 5 24 2 0 17 15 8 4 ...What would be the next number after 11 generated by the PRNG?  |blank|
...
.. fillintheblank:: mcsp-4-7-2
    ...
    Suppose your PRNG uses the following formula:Xi+1 = Xi * 2 + 1And suppose that X1 is 12.  What value will X2 have? |blank|
...
.. fillintheblank:: mcsp-4-7-3
    ...
    Suppose your PRNG uses the following formula:Xi+1 = Xi * 2 + 1And suppose that X1 is 10.  What are the next three numbers that the formula would generate?   Type your answers into the text box, separating the numbers by a single comma. |blank|
...
.. raw:: html
    ...
    The <b>MOD</b> operator gives the remainder when one number is divided by another. For example, 3 MOD 2 is 1 because 3 can be divided by 2 once with a remainder of 1.  In the AP CSP exam, the a MOD b operator is defined as the remainder of a divided by b for positive numbers a and b. App Inventor also has a "Modulo of" block. In arithmetic expressions, the MOD operator has the same precedence as the * and / operators which means that MOD, *, and / are evaluated before + and - unless there are parentheses. 
...
.. fillintheblank:: mcsp-4-7-7
    ...
    Suppose your PRNG uses the following formula:                Xi+1 = (Xi * 2 + 1)  mod 13What would the next number be if the current number is 10? |blank|
...
.. fillintheblank:: mcsp-4-7-8
    ...
    Suppose your PRNG uses the following formula:                Xi+1 = (Xi * 2 + 1)  mod 13What would the next five numbers be if the current number is 10?  Separate the numbers in your sequence by commas. |blank|
